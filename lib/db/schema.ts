...
export const assetImages = pgTable('asset_images', {
  ...
  generationProvider: varchar('generation_provider', { length: 40 }),
  generationModel: varchar('generation_model', { length: 120 }),
  generationPromptVersion: varchar('generation_prompt_version', { length: 80 }),
